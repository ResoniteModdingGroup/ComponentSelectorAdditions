...
namespace ComponentSelectorSearch
{
    ...
    {
        private static readonly Type componentAttacherType = typeof(ComponentSelector);
        ...
        public AttacherDetails(ComponentSelector attacher)
        {
        ...
        public static AttacherDetails New(ComponentSelector attacher) => new(attacher);
    }
}